...
int main(int argc,char *argv[])
{
  ...
  dat_read_aqd2(argv[1],&ad); // read datafile outputed by 'aw_d3aqd2_bv_solver'
  ...
  pv_t_aqd2(&p,v,r,type,&ad); // calclation of total field ( add incident field to scattered field )
