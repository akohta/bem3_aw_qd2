...
void force_FN_aqd2(double *F,double *N,double *rc,int type,AQD2 *ad)
{
  void bil_force_4p(double *F,double *N,double *rc,int s,AQD2 *ad);
  void bil_force_9p(double *F,double *N,double *rc,int s,AQD2 *ad);
  void lit_force_4p(double *F,double *N,double *rc,int s,AQD2 *ad);
  void lit_force_7p(double *F,double *N,double *rc,int s,AQD2 *ad);
...
void surface_area_aqd2(double *S,int did,int type,AQD2 *ad)
{
  void bil_sa_4p(double *S,int d,int s,AQD2 *ad);
  void bil_sa_9p(double *S,int d,int s,AQD2 *ad);
  void lit_sa_4p(double *S,int d,int s,AQD2 *ad);
  void lit_sa_7p(double *S,int d,int s,AQD2 *ad);
...
void bil_force_9p(double *F,double *N,double *rc,int s,AQD2 *ad)
{
  ...
  for(i=0;i<9;i++){
    ...
    pv_t_bd_aqd2(&p,v,0,s,ad->bd.zt_49[i],ad->bd.et_49[i],1,ad);
...
void lit_force_4p(double *F,double *N,double *rc,int s,AQD2 *ad)
{
  ...
  for(i=0;i<4;i++){
    if(i<3){
      ...
      pv_t_bd_aqd2(&p,v,0,s,ad->bd.zt_34[i],ad->bd.et_34[i],0,ad);
    }
...
void lit_force_7p(double *F,double *N,double *rc,int s,AQD2 *ad)
{
  ...
  for(i=0;i<7;i++){
    ...
    pv_t_bd_aqd2(&p,v,0,s,ad->bd.zt_37[i],ad->bd.et_37[i],1,ad);
